...
export default function Header() {
  ...
  return (
    <>
      <header className="mt-12 mb-6 flex flex-col items-center md:mt-16 md:mb-0 md:flex-row xl:mt-24">
        <Image
          alt="avatar"
          blurDataURL="/static/icons/blur.svg"
          className="drag-none h-[120px] w-[120px] cursor-pointer rounded-full bg-cover bg-neutral-900 ring ring-emerald-700 ring-offset-4 ring-offset-black transition-shadow hover:ring-yellow-700 hover:ring-offset-8 hover:ring-offset-black md:ml-1"
          height={256}
          ...
          width={256}
        />
        <div className="mt-6 ml-0 flex flex-col md:mt-0 md:ml-7">
          <h1 className="items-center font-bold text-2xl text-neutral-50">
            Hey, {`I'm`}{" "}
          ...
          <div className="group relative mt-1 w-full border-neutral-900 border-t-4 pt-1 text-[1rem] text-neutral-200 leading-[1.4rem] sm:text-justify">
            <PlayAudio />
            I’m a self-taught web developer {`who's `}
            <span className="inline-block w-[98px] font-bold text-emerald-400 text-sm">
              {years}
            </span>{" "}
      ...
      <div className="z-20">
        <div className="flex flex-row items-center justify-between pt-5 pl-0 text-neutral-300 md:pl-1">
          ...
          <div className="flex flex-row-reverse items-start gap-2">
            <AIBotAssistant />
            <p className="fade-opacity -z-10 -mt-1 xs:block hidden rotate-6 select-none rounded-sm bg-neutral-900 px-2 py-1 text-[0.6rem] text-neutral-500 sm:text-xs">
              {"AI Assistant ->"}
            </p>
          </div>
        </div>
        <div className="flex flex-row flex-wrap items-center justify-between pt-5">
          <Media />
          <Link
            className="group text-emerald-500 text-sm hover:text-opacity-80"
