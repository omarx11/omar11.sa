  ...
  return (
    <div className="mb-8 space-y-4 md:space-y-10">
      <div className="rounded-lg border-2 border-neutral-700/40 bg-neutral-900/50 p-4">
        ...
        <ol className="mt-6 space-y-4">
          <li className="flex items-center gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center overflow-hidden rounded-full border border-neutral-700/50 bg-neutral-800 shadow-md shadow-neutral-800/5 ring-0 ring-neutral-900/5">
              <svg
      ...
      <div className="rounded-lg border-2 border-neutral-700/40 bg-neutral-900/50 p-4">
        ...
        <ol className="mt-6 space-y-4">
          <li className="flex items-center gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full border border-neutral-700/50 bg-neutral-800 shadow-md shadow-neutral-800/5 ring-0 ring-neutral-900/5">
              <svg
                id="color__icon"
                xmlns="http://www.w3.org/2000/svg"
                width="30"
